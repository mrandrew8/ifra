...
```
cd existing_repo
git remote add origin https://gitlab.praktikum-services.ru/std-024-12/infrastructure.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.praktikum-services.ru/std-024-12/infrastructure/-/settings/integrations)
